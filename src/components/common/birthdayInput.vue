  ...
  <div class="birthday">
    ...
    <div class="icon">
      ...
      <div class="normal" :class="{ hide: showZodiac }">
        ...
        <svg class="cake-light" viewBox="0 0 36 36" aria-hidden="true"><use xlink:href="#cake-light" /></svg>
        <svg class="cake" viewBox="0 0 36 36" aria-hidden="true"><use xlink:href="#cake" /></svg>
      </div>
    ...
    >
      ...
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M15.5 14h-.79l-.28-.27a6.471 6.471 0 0 0 1.57-4.23 6.5 6.5 0 1 0-6.5 6.5 6.471 6.471 0 0 0 4.23-1.57l.27.28v.79l5 5 1.5-1.5-5-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
      </svg>
    </button>
  ...
  methods: {
    ...
    onInput(e) {
      ...
      if (e?.target === this.$refs.dd) {
        ...
        const A = (typeof e.data === 'string' && e.data.length === 1 && /^\d$/.test(e.data))
          ? parseInt(e.data, 10)
          : NaN;
        ...
        if ((Number.isFinite(A) && A >= 4 && Number.isFinite(B) && B <= 10) ||
        ...
        if ((Number.isFinite(A) && A >= 2 && Number.isFinite(B) && B <= 10) ||
            (Number.isFinite(B) && B >= 10 && B <= 12)) {
          if (this.$refs.yyyy) {
            if (B < 10) {
...
.icon .normal { transition: opacity .2s; }
.icon .normal.hide { opacity: 0; }
...
/* placeholder */
.birthday input::placeholder { color: #999fb7; }
